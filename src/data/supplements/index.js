...
export const SUPPLEMENT_RANGED_WEAPONS = Object.assign(
  {},
  ...supplements.map((s) => s.ranged_weapons || {}),
);

export const SUPPLEMENT_COMBAT_WEAPONS = Object.assign(
  {},
  ...supplements.map((s) => s.combat_weapons || {}),
);
